...
def run_all_tests():
    ...
    test_cases = [
        ...
        {"service": "s3", "intent": "list_s3_buckets", "entities": {}},
        # EC2 Tests
        {
            "service": "ec2",
        ...
        # DynamoDB Tests
        {"service": "dynamodb", "intent": "list_dynamodb_tables", "entities": {}},
        {
            "service": "dynamodb",
        ...
        # IAM Tests
        {"service": "iam", "intent": "list_iam_users", "entities": {}},
        {
            "service": "iam",
    ...
    for test in test_cases:
        test_service_command(test["service"], test["intent"], test["entities"])
